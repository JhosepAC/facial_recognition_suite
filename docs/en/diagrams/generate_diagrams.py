"""Regenerates docs/en/diagrams/{architecture,class_diagram}.png with matplotlib.

Usage:
    .venv\\Scripts\\python.exe docs/en/diagrams/generate_diagrams.py

Requires only matplotlib (already included in requirements.txt). Diagrams are
generated with a dark theme consistent with the UI.
"""
import os
import matplotlib
matplotlib.use("Agg")
...
def uml():
    ...
    fig.savefig(os.path.join(OUT, "class_diagram.png"), dpi=150)
    plt.close(fig)
    print("class_diagram.png OK")
